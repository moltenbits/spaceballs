...
enum AppBundleHelper {
  ...
  static func findInstalledAppBundle() -> String? {
    ...
    let relativePath = (prefixDir as NSString).appendingPathComponent(
      "lib/spaceballs/Spaceballs-CLI.app")
    ...
    let fallbacks = [
      "/usr/local/lib/spaceballs/Spaceballs-CLI.app",
      "/opt/homebrew/lib/spaceballs/Spaceballs-CLI.app",
    ]
    ...
    // Development build
    let devPath = (binDir as NSString).appendingPathComponent("../Spaceballs-CLI.app")
